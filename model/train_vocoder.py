...
def main():
    ...
    data_path = '../data/IU, ../data/kss'
    parser.add_argument('--data_dir', type=str, default=data_path, help='The directory containing the VCTK corpus.')
    ...
    try:
        ...
        print("Something went wrong while restoring checkpoint. We will terminate training to avoid accidentally overwriting the previous model.", e)
        raise e
